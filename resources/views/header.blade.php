        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <a data-aos="fade-up" data-aos-delay="200" href="#get-started" class="btn-get-started aos-init aos-animate">Get Started</a>
            </div>
          </div>
        </div>
      </div>
  
      <div id="hero-carousel" class="carousel slide pointer-event" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <section id="get-started" class="get-started section-bg">
        <div class="container">
          ...
          <div class="row justify-content-between gy-4">
            ...
            <div class="col-lg-6 d-flex align-items-center aos-init" data-aos="fade-up">
              <div class="content">
                <h3>Minus hic non reiciendis ea possimus at quia.</h3>
                <p>Rem id rerum. Debitis deserunt quidem delectus expedita ducimus dolor. Aut iusto ipsa. Eos ipsum nobis ipsa soluta itaque perspiciatis fuga ipsum perspiciatis. Eum amet fugiat totam nisi possimus ut delectus dicta.
                </p><p>Aliquam velit deserunt autem. Inventore et saepe. Tenetur suscipit eligendi labore culpa eos. Deserunt porro magni qui necessitatibus dolorem at animi cupiditate.</p>
              </div>
            </div>
  
            <div class="col-lg-5 aos-init" data-aos="fade">
      ...
      <section id="alt-services" class="alt-services">
        <div class="container aos-init" data-aos="fade-up">
          ...
          <div class="row justify-content-around gy-4">
            <div class="col-lg-6 img-bg aos-init" style="background-image: url(assets/img/alt-services.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
      ...
      <section id="projects" class="projects">
        <div class="container aos-init" data-aos="fade-up">
          ...
          <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
            ...
            <ul class="portfolio-flters aos-init" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4 portfolio-container aos-init" data-aos="fade-up" data-aos-delay="200" style="position: relative; height: 4932px;">
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling" style="position: absolute; left: 0px; top: 1644px;">
                <div class="portfolio-content h-100">
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-design" style="position: absolute; left: 0px; top: 4521px;">
                <div class="portfolio-content h-100">
      ...
      <section id="testimonials" class="testimonials section-bg">
        <div class="container aos-init" data-aos="fade-up">
          ...
          <div class="slides-2 swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
            <div class="swiper-wrapper" id="swiper-wrapper-81076ce3b43eef2bd" aria-live="off" style="transform: translate3d(-2144px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" role="group" aria-label="5 / 5" style="width: 516px; margin-right: 20px;" data-swiper-slide-index="4">
              ...
              <div class="swiper-slide" role="group" aria-label="1 / 5" style="width: 516px; margin-right: 20px;" data-swiper-slide-index="0">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
              ...
              <div class="swiper-slide" role="group" aria-label="2 / 5" style="width: 516px; margin-right: 20px;" data-swiper-slide-index="1">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
              ...
              <div class="swiper-slide swiper-slide-prev" role="group" aria-label="3 / 5" style="width: 516px; margin-right: 20px;" data-swiper-slide-index="2">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
              ...
              <div class="swiper-slide swiper-slide-active" role="group" aria-label="4 / 5" style="width: 516px; margin-right: 20px;" data-swiper-slide-index="3">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
              ...
              <div class="swiper-slide swiper-slide-next" role="group" aria-label="5 / 5" style="width: 516px; margin-right: 20px;" data-swiper-slide-index="4">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <img src="assets/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                    <h3>John Larson</h3>
            ...
            <div class="swiper-slide swiper-slide-duplicate" role="group" aria-label="1 / 5" style="width: 516px; margin-right: 20px;" data-swiper-slide-index="0">
                <div class="testimonial-wrap">
                  <div class="testimonial-item">
                    <img src="assets/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
                    <h3>Saul Goodman</h3>
    ...
    <div class=" section-header">
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100 aos-init" data-aos="fade-up" data-aos-delay="300">
